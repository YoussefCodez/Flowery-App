...
Widget sortTile({required String title, required SortOption value, required SortOption selected, required BuildContext context}) {
    return Container(
      ...
      child: RadioMenuButton<SortOption>(
        ...
        groupValue: selected,
        onChanged: (value) {
          context.read<FilterViewModel>().doEvent(UpdateSortOptionEvent(value!));
        },
        child: Text(title),
      ),
