...
class MockCashOrderUseCase extends Mock
    implements CheckoutCashOrderUseCase {}
    ...
    blocTest<CheckoutViewModel, CheckoutState>(
      ...
      build: () {
        when(() => cashUseCase.call(any())).thenAnswer(
          (_) async => Success(
            data: CashOrderEntity(message: 'Success'),
          ),
        );
