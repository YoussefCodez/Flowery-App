...
class MockAddressDetailsUseCase extends Mock
    implements UpdateAddressDetailsUseCaseRemote {}
...
void main() {
  ...
  setUp(() {
    ...
    entity = const AddressDetailsResponseEntity(
      message: "success",
      address: [
        AddressEntity(
          street: "street",
    ...
    governorate1 = GovernorateModel(
      id: "gov1",
      nameAr: "القاهرة",
      nameEn: "Cairo",
    );
    governorate2 = GovernorateModel(
      id: "gov2",
      nameAr: "الجيزة",
      nameEn: "Giza",
    );
