...
@Injectable(as: AddressDetailsDataSourceRemoteContract)
class AddressDetailsDataSourceRemoteImpl
    implements AddressDetailsDataSourceRemoteContract {
  final AddressDetailsApiClient apiClient;

  AddressDetailsDataSourceRemoteImpl({required this.apiClient});
  @override
